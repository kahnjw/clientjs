...
var initClientJs = (function(scope) {
  ...
  var getMurmHash = function() {
    return require('./vendor/murmurhash3.js');
  };
  ...
  var ClientJS = function() {
    var parser = new(require('./vendor/ua-parser.js'));
    var Detector = (require('./vendor/fontdetect.js'));
  ...
  ClientJS.prototype = {
    ...
    isMobile: function() {
      // detectmobilebrowsers.com JavaScript Mobile Detection Script
      var dataString = browserData.ua || navigator.vendor || scope.opera;
